...
\todo[inline]{Discuss all results related to nuclear spin mapping}
	...
	\begin{figure}[htbp!]
		\centering
		\includegraphics[width=0.8\textwidth]{WaitTimeFigLog_1p4T}
		\includegraphics[width=0.8\textwidth]{WaitTimeFigLog_1p0T}
...
\subsection{Improper Initialisation due to Trigger Latency}
	\todo[inline]{Put a plot here of MATLAB latency, and describe the cause and effect of it.}
