...
\subsubsection{Quantum Devices}
	...
	Recalling the Zeeman splitting energy (Section \ref{zeeman}) that is created through the application of an external magnetic field, if we can then shift the average energy level of an electron, we can allow the higher energy state to be transmitted through the coulomb blockade, while the lower energy state will not be transmitted, due to the coulomb blockade \todo[inline]{This is misleading, coulomb blockade is due to the presence/absence of an electron on the gate in our setup.}. This is known as spin-dependent tunneling, and in silicon, the higher energy state is spin up. This is depicted in Figure \ref{fig::set_loading}, where diagram b shows the Fermi level in green, and the red and blue lines are the energy levels of a spin-up and spin-down electron, respectively. 
...
\subsection{Quantum Control}
	...
	\begin{figure}[htbp!]
		\centering
		\includegraphics[width=0.8\textwidth]{steering}
	...
	\begin{figure}[htbp!]
		\centering
		\includegraphics[width=0.8\textwidth]{steering_log}
