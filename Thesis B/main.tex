...
\input{./src/real-time_processing}
\pagebreak
\section{Results}
\input{./src/results}
\pagebreak
\section{Design Improvements}
\input{./src/design_improvements}
\pagebreak
%\section{Prospective Results}
%\input{./src/simulation_results}
%\pagebreak
\section{Conclusion}
...
\begin{appendices} 
	...
	\input{./src/supplementary_info}
	\section{MATLAB Software Highlight}
	\lstinputlisting[breaklines=true, language=MATLAB]{./src/code_digitizer}
\end{appendices}
\end{document}
